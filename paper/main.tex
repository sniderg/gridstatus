...
\begin{enumerate}
    \item \textbf{4CP Prediction}: Industrial users reduce load during the four highest system peaks (4CP) to lower transmission charges. Our analysis shows a divergence between price peaks (20:00--23:00, driven by solar ramp-down) and system load peaks (16:00--18:00). Future work should model system load explicitly to support 4CP avoidance strategies.
